...
public class Methodtesting {
	...
	public static void main(String[] args) {
		...
		System.out.println(Methods.reverse("Alabama is still Alabama backwards"));
		...
		System.out.println(Methods.count('t', "ecstatic"));
		System.out.println("Count färdig");
		
		System.out.println(Methods.fahrenheitToCelsius(22));
		System.out.println("Fahrenheit färdig");
